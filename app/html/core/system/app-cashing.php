                                        ...
                                        if($resWaiting['status']){
                                            foreach($resWaiting['data'] as $row2){
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: top;" class="text-right">
                                                            <button class="btn btn-icon rounded-circle btn-outline-success" style="height: 40px; width: 40px; padding-top: 1px; margin-bottom: 3px;" onclick="window.location='../../../controller/create_service.php?patient_id=<?php echo $row2['patient_id']; ?>'"><i class="bx bx-search" style="font-size: 1.3em;"></i></button>
                                                            <button class="btn btn-icon rounded-circle btn-outline-success" style="height: 40px; width: 40px; padding-top: 1px; margin-bottom: 3px;" onclick="window.location='../../../controller/create_service.php?patient_id=<?php echo $row2['patient_id']; ?>'"><i class="bx bx-dollar" style="font-size: 1.3em;"></i></button>
